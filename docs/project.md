ToldenInternet Project
===============

The ToldenInternet project is developing a document browser for the World
...
ToldenInternet is very modular and built from many component libraries which
provide functionality from GIF image format decoding (libnsgif) to
HTML document object model handling (libdom).

ToldenInternet browser is open source and is licensed under the GPLv2 (with
